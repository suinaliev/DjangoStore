...
# STRIPE PAYMENT
STRIPE_PUB_KEY = os.environ.get('STRIPE_PUB_KEY', 'pk_test_OKdhbDNME5KHtnpzYRBfNmEZ00mjM6DVsJ')
STRIPE_SECRET_KEY = os.environ.get('STRIPE_SECRET_KEY', 'sk_test_jaIdMJOlkcUG6QpXV5wAJxXT005aZAJVM1')
